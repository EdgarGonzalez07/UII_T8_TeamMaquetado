...
import utez.edu.mx.ui.screens.AudioListScreen
import utez.edu.mx.ui.screens.ImageListScreen
import utez.edu.mx.ui.screens.RecordingScreen
import utez.edu.mx.ui.screens.VideoListScreen
import utez.edu.mx.ui.screens.VideoPlayerScreen
import utez.edu.mx.viewmodel.MediaView
import utez.edu.mx.viewmodel.MediaViewFactory
import utez.edu.mx.viewmodel.PlaybackFactory
...
fun AppNavigation() {
    ...
    val mediaViewModel: MediaView = viewModel(
        factory = MediaViewFactory(application)
    )
    val playbackViewModel: PlaybackView = viewModel(
        factory = PlaybackFactory(application)
    )
